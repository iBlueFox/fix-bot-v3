...
global.namebot = 'Slebew-V1'
global.nameown = 'Fandyyy'
...
/*============== WATERMARK ==============*/
global.wm = '                「 Slebew-V1 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘ Slebew-V1 ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ Slebew-V1 '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By Fandyyy`
global.packname = '☂︎ ᴄʀᴇᴀᴛᴇᴅ ʙʏ'
global.author = '                「 Slebew-V1  あ」'
...
/*============== STICKER WM ==============*/
global.stickpack = 'Slebew-V1'
global.stickauth = `By ©Fandyy`
